...
\section{Related Works} \label{sec:related}
   ...
   \subsection{Machine Learning vs Deep Learning Algorithms} \label{sec:related-dl-vs-ml}
      In the paper Automatic Pulmonary Nodule Detection \cite{ml_vs_dl}, the authors sought out to systematically compare the results and algorithms of
      ...
      Among the algorithms found in the feature-based framework in the ML category, the most popular
...
\section{Experiments} \label{sec:experiments}
   ...
   \subsection{General Performance} \label{sec:experiments-general-performance}
      ...
      The figure below \ref{fig:experiments-general-acc-loss} shows the accuracy and loss of the general baseline model over 10 epochs for the first sector.
   ...
   \subsection{Varying Sector Number} \label{sec:experiments-sector}
      \subsubsection{1 Sector Model} \label{sec:experiments-sector-1}
