...
\section{Experiments} \label{sec:experiments}
   Three primary ideas were tested in this project. One was to determine if the model proposed generally performed well on the given data and to see 
   if the model generally performed well when compared to the results from \ref{sec:related-dl-vs-ml}. The second goal was to analyze if shifting the 
